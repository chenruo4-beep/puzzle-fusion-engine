  ...
  "directions": [
    {
      ...
      "why_this_works": "200-300字，深入解释这个组合为什么能打。必须引用用户的具体碎片，说明碎片之间是怎么联动的。比如：'你有A碎片和B碎片，这两样东西放在一起，就变成了——你既懂X，又能在Y场景下用出来，而市面上大部分会X的人不懂Y，会Y的人没条件做X。这就是你的小壁垒。'",
      "market_hint": "100-150字，这个方向能做什么、谁会为它花钱、大概什么场景下成交。要具体，比如'本地小老板想宣传但不会拍视频'或'同城宝妈需要一个信得过的二手闲置撮合人'。",
      "difficulty": "easy/medium/hard",
      "time_to_first_result": "预计多久见到第一个正向反馈（如'1-2周''1个月''3个月'）",
      "roadmap": [
        {"step": 1, "time": "第1周", "action": "第一步具体做什么"},
        {"step": 2, "time": "第2-3周", "action": "第二步具体做什么"},
        {"step": 3, "time": "第4-6周", "action": "第三步具体做什么"}
      ],
      "used_fragments": ["碎片类型: 碎片内容", "碎片类型: 碎片内容"],
      "next_action": "今天就能做的第一步，必须是具体动作（注册/发布/联系/发帖），不能是学习/思考/规划。比如'在闲鱼发布第一条服务信息'或'注册小红书账号发第一条内容'或'给3个本地商家发消息问他们要不要拍视频'"
    }
  ],
  "insight": "300-400字的整体洞察。核心是帮用户看到他碎片组合的独特壁垒——为什么别人抄不走他的组合。要点：①他的碎片拼出了一个什么独特画像 ②同城/同行业里有多少人同时有这些 ③这个组合能在什么细分场景下碾压别人 ④这个方向做到后面会形成什么复利。语言要像老朋友在帮他分析，不要学术腔。",
  "skill_gaps": ["缺什么1（具体的能力/资源/条件）", "缺什么2", "缺什么3"],
  "fragment_connections": [
    {"fragment_a": "碎片类型: 碎片内容", "fragment_b": "碎片类型: 碎片内容", "connection": "这俩碎片之间的隐藏关联——为什么它们放在一起会产生1+1>2的效果。用一句话说清楚，让人恍然大悟"},
