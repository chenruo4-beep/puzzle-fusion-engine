  ...
  const cases = [
    {
      ...
      detail: "王姐教了12年语文，一直觉得'副业'跟自己没关系。用拼拼看Me梳理后，发现自己最值钱的不是'语文知识'，而是'批改作文时一眼看出问题所在'的能力。现在她的暑假作文陪跑营，家长排队报名。",
    },
    {
      name: "小李",
      role: "外卖骑手",
    ...
    },
    {
      ...
      detail: "阿杰写了5年代码，笔记散落在10个文件夹里。用拼拼看Me整理后，发现可以串成一套'从零学React'的系列教程。现在专栏每月被动收入够付房租。",
    },
  ];
