...
export default function ConfirmFragmentsContent() {
  ...
  return (
    <div className="min-h-screen bg-warm-bg flex flex-col">
      <div className="w-full h-1 bg-warm-dark/10">
        <div className="h-full bg-warm-accent w-2/3 transition-all duration-500" />
      </div>
      ...
      <div className="flex-1 px-6 pb-40 overflow-y-auto">
        <div className="space-y-3 max-w-2xl mx-auto">
          <h3 className="text-xs font-medium text-warm-dark/40 px-1">预置碎片 · {templateFragments.length}个</h3>
